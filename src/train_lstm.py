...
def train_model():
    ...
    print(f"--- Training LSTM on Device: {device.type.upper()} ---")
    ...
    # Increased epochs to 50 to let the model escape the local minimum
    num_epochs = 50 
    ...
    for epoch in range(num_epochs):
        ...
        # Multiply by 125 here so the printed terminal output is still in real flights
    ...
    print("Saved trained model to models/lstm_weights.pth")
